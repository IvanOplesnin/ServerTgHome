...
Admin-only команды: `/clip`, `/record`, `/videos`, `/last`, `/snapshot`, `/arm`, `/disarm`, `/mute`, `/ac_on`, `/panel`, кнопки камеры в `door` панели, кнопки отправки сохраненных видео и voice playback.
